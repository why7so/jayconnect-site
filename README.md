...
```
index.html    — вся страница (герой, возможности, шаги, тарифы, платформы, FAQ)
style.css     — оформление; тема тёмная, акцент #52aa52 — как в мини-приложении
main.js       — появление блоков при скролле, счётчики, FAQ, мобильное меню
